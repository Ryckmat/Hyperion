...
from hyperion.config import NEO4J_URI, NEO4J_USER, NEO4J_PASSWORD, NEO4J_DATABASE, BATCH_SIZE_COMMITS
...
class Neo4jIngester:
    ...
    def _ingest_contributors(self, tx, repo_name: str, contributors: list):
        ...
        """, repo=repo_name, contributors=contributors)
    ...
    def _ingest_hotspots(self, tx, repo_name: str, hotspots: list):
        ...
        """, repo=repo_name, hotspots=hotspots)
    ...
    def _ingest_directories(self, tx, repo_name: str, directories: list):
        ...
        """, repo=repo_name, directories=directories)
    ...
    def _ingest_extensions(self, tx, repo_name: str, extensions: list):
        ...
        """, repo=repo_name, extensions=extensions)
