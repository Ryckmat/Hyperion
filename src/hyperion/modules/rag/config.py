...
LLM_TEMPERATURE = float(os.getenv("LLM_TEMPERATURE", "0.0"))  # 0 pour vitesse max
LLM_MAX_TOKENS = int(os.getenv("LLM_MAX_TOKENS", "256"))  # Drastiquement réduit 512→256
LLM_TOP_K = int(os.getenv("LLM_TOP_K", "1"))  # Un seul chunk pour vitesse ultime 2→1
LLM_TIMEOUT = int(os.getenv("LLM_TIMEOUT", "3"))  # Timeout très strict 5→3s
