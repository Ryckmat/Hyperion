...
Hyperion v1.5 est une plateforme d'analyse Git et de RAG (Retrieval Augmented Generation) conçue pour :

1. **Analyser en profondeur** les dépôts Git (commits, contributeurs, hotspots)
2. **Indexer sémantiquement** les profils Git dans Qdrant
3. **Offrir une interface conversationnelle** via RAG pour explorer les données
4. **Exposer une API OpenAI-compatible** pour intégration avec Open WebUI
5. **Fournir un dashboard** React pour visualisation
...
│  │         Core Business Logic                 │          │
│  │  ┌──────────────┐    ┌──────────────┐      │          │
│  │  │ GitAnalyzer  │    │ RAGEngine    │      │          │
│  │  └──────────────┘    └──────────────┘      │          │
│  └───────────────┬──────────────┬──────────────┘          │
│                  │              │                          │
│  ┌───────────────┴──┐    ┌──────┴───────────┐            │
│  │  Git Repository  │    │  Vector Database │            │
│  │  (Local FS)      │    │  (Qdrant)        │            │
│  └──────────────────┘    └──────────────────┘            │
│                                                             │
│  ┌────────────────────────────────────────────┐            │
...
Voir [V2-VISION.md](V2-VISION.md) pour détails complets.
...
- [V2-VISION.md](V2-VISION.md) - Vision v2.0
