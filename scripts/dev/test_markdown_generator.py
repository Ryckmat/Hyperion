...
def main():
    ...
    profile_path = Path(__file__).parent.parent / "data" / "repositories" / "requests" / "profile.yaml"
    
    if not profile_path.exists():
        print(f"❌ Profil introuvable : {profile_path}")
        print("💡 Lance d'abord : python3 scripts/hyperion_full_workflow.py /home/kortazo/Documents/requests")
        sys.exit(1)
